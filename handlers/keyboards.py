...
from databases.requests import get_categories , get_product,get_products
...
async def product(category_id):
    ...
    for products in product:
        product_kb.add(InlineKeyboardButton(text=products.name, callback_data=f'product_{products.id}'))
